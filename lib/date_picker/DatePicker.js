    ...
    _createClass(DatePicker, [{
      ...
      value: function render() {
        var _props = this.props,
            ...
            value = _props.value,
            others = _objectWithoutProperties(_props, ['active', 'autoOk', 'cancelLabel', 'inputClassName', 'inputFormat', 'locale', 'maxDate', 'minDate', 'okLabel', 'onEscKeyDown', 'onOverlayClick', 'readonly', 'sundayFirstDayOfWeek', 'value']);
